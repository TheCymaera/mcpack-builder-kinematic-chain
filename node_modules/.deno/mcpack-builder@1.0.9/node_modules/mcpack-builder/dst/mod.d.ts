...
export declare function command(strings: TemplateStringsArray, ...values: any[]): CustomCommand;
export declare class ScoreboardTag {
    tag: string;
    constructor(tag: string);
    add(target: EntitySelector): CustomCommand;
    remove(target: EntitySelector): CustomCommand;
    static list(target: EntitySelector): CustomCommand;
}
...
export declare class EntitySelector implements TargetSelector {
    ...
    isType(type: string): this;
    hasScoreboardTag(tag: string | ScoreboardTag): this;
    noScoreboardTag(tag: string | ScoreboardTag): this;
    sortNearest(): this;
    sortFurthest(): this;
    sortRandom(): this;
    sortArbitrary(): this;
...
export declare class Execute implements Command {
    ...
    ifExists(target: TargetSelector): this;
    unlessExists(target: TargetSelector): this;
...
export declare class Datapack {
    ...
    functions: Map<NamespacedID, DatapackFunctionProvider>;
    onLoadFunctions?: Tag;
    onTickFunctions?: Tag;
